...
/**
	...
	public WcUser findByEmail(Object email) {
		// TODO Auto-generated method stub
		
					List<WcUser> l=findByProperty("email", email
							);
					if (l.size()==0) {
						return null;
					}
	...
	public List<WcUser> findByFriend(WcUser me, final int...rowStartIdxAndCount) {
		// TODO Auto-generated method stub
		EntityManagerHelper.log("findByFriend", Level.INFO, null);
		try {
	...
	public List<WcUser> findByUserIdIn( final List value
	        , final int...rowStartIdxAndCount
	        ) {
		String jpql = "select o from WcUser o where userId in(:ids)";
		List<WcUser> modules = getEntityManager().createQuery(jpql).setParameter("ids", value).getResultList();
	    		return modules;
		}
